...
test("checkGroup test 1 - empty Values", () => {
    ...
    const set = Validate.checkGroup(val, group);
...
test("checkGroup test 2.0 - single group", () => {
    ...
    const set1 = Validate.checkGroup(val1, group1);
    ...
    const set2 = Validate.checkGroup(val2, group1);
    ...
    const set3 = Validate.checkGroup(val3, group1);
    ...
    const set4 = Validate.checkGroup(val4, group1);
