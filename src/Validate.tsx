...
// Needs to move to NormalBoard wrapper in future version.
const normalSudokuGroupings: Groupings =
    // ROWS
    [[0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 , 8],
 ...
 *        board to their corresponding SquareValue.
 */
export function normalSudokuValidator(values: Values): Contradictions {
    return checkGroupings(values, normalSudokuGroupings);
}
